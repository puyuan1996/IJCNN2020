...
if __name__ == "__main__":
    ...
    parser.add_argument('--rl_fq', type=int, default=5)  # 5
    ...
    parser.add_argument('-latent_bs','--latent_buffer_size', type=int, default=5000)  # 1e6
    parser.add_argument('-rl_bs','--rl_buffer_size', type=int, default=5000)  # 5000
