...
if __name__ == "__main__":
    ...
    parser.add_argument('-latent_uf', '--latent_encoder_update_frequency', type=int, default=10000)  # 5000
    parser.add_argument('-rl_uf', '--rl_update_frequency', type=int, default=1000)  # 1e4

    parser.add_argument('-latent_bs','--latent_buffer_size', type=int, default=10000) #50000
    parser.add_argument('-rl_bs','--rl_buffer_size', type=int, default=10000)#5000
